...
class DigitalTimer extends Component {
    ...
    return (
      <div className="timer-limit-control-cont">
        ...
        <div className="timer-limit-controller">
          ...
          <div className="limit-label-value-cont">
  ...
  renderTimerController = () => {
    ...
    return (
      <div className="timer-cntrl-cont">
        <button
          className="timer-cntrl-btn"
          onClick={this.onStartOrPauseTimer}
          type="button"
        >
          <img
            alt={startOrPauseAltText}
            className="timer-cntrl-icon"
            src={startOrPauseImageUrl}
          />
          <p className="timer-cntrl-label">
        ...
        >
          ...
          />
          <p className="timer-cntrl-label">Reset</p>
        </button>
      </div>
    )
  }
